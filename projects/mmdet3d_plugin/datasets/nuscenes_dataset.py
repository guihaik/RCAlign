...
class CustomNuScenesDataset(NuScenesDataset):
    ...
    def __init__(self, collect_keys, seq_mode=False, seq_split_num=1, num_frame_losses=1, queue_length=8, random_length=0, cam=False, *args, **kwargs):
    ...
    def get_data_info(self, index):
        ...
        if not self.test_mode or self.cam:
